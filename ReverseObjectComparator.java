...
import java.util.Comparator;
 ...
 final class ReverseObjectComparator<T> implements Comparator<T> {

	private String PrimaryValue,SecondaryValue;
	
	public ReverseObjectComparator(String PrimaryValue, String SecondaryValue) {
	...
	public int compare(T o1 , T o2) {
		...
		return getSecondayValue(o1).compareTo(getSecondayValue(o2));
		}
		else {
		return -1;
		}
